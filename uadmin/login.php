      ...
      <div class="wrap-login100">
        <form class="login100-form validate-form" method="post" action="login.php">
          ...
          <span class="login100-form-title p-b-48">
            <img src="../logo.png" height="40" style="width: auto;">
          </span>
          ...
          <div class="container-login100-form-btn">
            <div class="wrap-login100-form-btn">
              ...
              <button class="login100-form-btn coin" type="submit" name="signin">
                Login
              </button>
            </div>
          </div>
        ...
        <style>
            ...
            button.coin:hover{
                background: linear-gradient(270deg, #034fab 0%, #064aa8 4.58%, #202a95 44.13%, #30178a 77.34%, #361086 100%);
                transition: 0.3s !important;
            }
        </style>
      </div>
