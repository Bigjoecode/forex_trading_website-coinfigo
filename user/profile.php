    ...
    if(!empty($img)){
        ...
        if($target == $returned_val){
            if (!empty($firstname) && !empty($lastname) && !empty($uphone) && !empty($ucountry)) {
                ...
                $update = mysqli_query($link, "UPDATE users SET fname = '$firstname', lname = '$lastname', phone = '$uphone', country = '$ucountry', gender = '$ugender', id_image = '$img' WHERE id = '$userId' ");
                        ...
                        <div class="col-md-6 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <center>
                                        <?php
                                        if(!isset($id_image) || $id_image == NULL){
                                            echo '<img src="images/userIcon2.png" alt="img" style="width: 100px;">';
                                        }else{
                                            echo '<img src="images/'.$id_image.'" alt="img" style="width: 100px;">';
                                        }
                                        ?>
                                        <br><br>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="POST" action="profile.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="firstname">Upload Image</label>
                                            <input type="file"  name="file_upload" class="form-control" placeholder="profile Picture"
                                                >
                                        </div>
                                        <div class="form-group">
