            ...
            if ($insert) {
                ...
                sendMail($email, $name, $subject, $body);
                 ...
                 //PHPMailer Object
                    ...
                    <p>You have a withdrawal request from:</p>
                        ...
                        <div class="col-md-5 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body" onc>
                                    ...
                                    <div style="font-size: 14px;" class="alert alert-secondary mb-4">Enter withdrawal
