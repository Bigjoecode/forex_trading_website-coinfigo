    ...
    if (!empty($amount) && !empty($duration)) {
        if ($account_type == 'demo') {
            ...
            if ($insert) {
                ...
                $body = "<p>Hi ".$name."</p> <p>A new stake has been registered successfully, below are the details<p> <center> <p><strong>Amount - ".$amount." </strong></p> <p><strong>Currency - ".$currency." </strong></p> <p><strong>duration - ".$duration." days </strong></p> <p><strong>ROI - ".$increase." </strong></p> <p><strong>date - ".$cdate." </strong></p> <p><strong>Edn date - ".$end_date." </strong></p>  </center> <p>If you have any questions, please contact support on our website or at <a href='mailto:support@coinfigo.com'>support@coinfigo.com</a> </p> <p>Join our Telegram and other media platforms. <br> Get an insight from other users about Coinfigo and their experiences. 300k+ members and counting. <a href='https://t.me/Coinfigotrades'>Join now</a> </p> <p>Regards,</p> <p>".$sitename."</p>";
                ...
                //PHPMailer Object
                    ...
                    $mail->Subject = "New Stake from ".$name;

                    $mail->Body = '<p>Dear Admin</p> 

                    <p>A client just initiated a new stake, here is the details of the client:</p>
                    ...
                    <p>Please confirm this notification.</p>
...
?>
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mt-4" id="stake-card">
                                        <div class="col-md-4 mb-3">
                                            <div class="card stakeCard" id="stakeCard"
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-4"><div style="width: 90%; background: white; align-items:center; padding:2px 2px 2px 4px; text-align:center; border-radius:50%">
                                                            <img style="width: 90%; aspect-ratio: 1/1;  border-radius:50% " 
                                                                src="currency/coin_logoo.png"
                                                                alt="Icon"></div>
                                                        </div>
                                                        <div class="col-8">
                                                            <div class="text-white">Coinfigo Coin</div>
                    ...
                    <script>
                        $(document).ready(function () {
                            var target = $('#stakeCard').get(0);
                       
                            $(document).on('click', '#stakeCard', function () {
                                var e_ = $(this);
                                if(this === target){
                                    alert("This package is currenctly unavailable");
                                }else{
