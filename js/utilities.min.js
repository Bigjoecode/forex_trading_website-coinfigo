...
var ActiveMenu = /*#__PURE__*/function () {
  function ActiveMenu() {
    ...
    this.navbar = document.querySelector(".".concat(this.navbarClass)) !== null ? document.querySelector(".".concat(this.navbarClass)).querySelectorAll('a') : false;
    this.dropdown = document.querySelectorAll(".".concat(this.dropdownClass));
    this.blogTitle = document.querySelector('main').getAttribute('data-title') !== null ? document.querySelector('main').getAttribute('data-title') : false;
  ...
  _createClass(ActiveMenu, [{
    ...
    value: function init() {
      if (document.querySelector(".".concat(this.navbarClass)) !== null) {
        ...
        this.addActiveBlog(this.blogTitle);
    ...
    value: function addActive(navbarParam) {
      ...
      location.pathname[location.pathname.length - 1] == '/' ? navbarParam[0].classList.add(this.activeClass) : navbarParam.forEach(function (e) {
        if (e.attributes[1].value.includes('../index.html') && e.attributes[1].value.slice(3) == _this.path) e.classList.add(_this.activeClass);
        if (e.attributes[1].value == _this.path) e.classList.add(_this.activeClass);
      });
    }
  }, {
    key: "addActiveParent",
    value: function addActiveParent(dropdownParam) {
      ...
      dropdownParam.forEach(function (e) {
        if (e.querySelector(".".concat(_this2.activeClass)) !== null) {
          e.previousElementSibling.classList.add(_this2.activeClass);
        }
      });
    }
  }, {
    key: "addActiveBlog",
    value: function addActiveBlog(title) {
      var _this3 = this;

      if (this.pageTitle.includes(title)) {
        var navbar = document.querySelector(".".concat(this.navbarClass));
        var addActive = navbar.querySelectorAll('li a');
        addActive.forEach(function (e) {
          if (e.textContent.toLowerCase() == title) {
            e.classList.add(_this3.activeClass);

            if (e.closest('.dropdown-menu') !== null) {
              e.closest('.dropdown-menu').previousElementSibling.classList.add(_this3.activeClass);
            }
          }
        });
      }
    ...
    key: "addDropdownHover",
    value: async function addDropdownHover() {
      var _this4 = this;

      var dropdown = await this.waitForSticky(".".concat(this.dropdownClass));
      dropdown.forEach(function (each) {
        each.previousElementSibling.onclick = function () {
          return _this4.hoverAction(each, 'click');
        };

        each.previousElementSibling.onmouseover = function () {
          return _this4.hoverAction(each, 'enter');
        };

        each.previousElementSibling.onmouseout = function () {
          return _this4.hoverAction(each, 'leave');
        };
    ...
    key: "hoverAction",
    value: function hoverAction(elem, mouse) {
      if (mouse == 'click') {
    ...
    key: "waitForSticky",
    value: function waitForSticky(selector) {
...
var PicturePlugin = /*#__PURE__*/function () {
  function PicturePlugin() {
    _classCallCheck(this, PicturePlugin);

    this.galleryWrap = document.querySelectorAll('.bigger-picture');
  }

  _createClass(PicturePlugin, [{
    key: "init",
    value: function init() {
      var _this = this;

      if (this.galleryWrap.length !== 0) {
        this.plugin = BiggerPicture({
          target: document.body
        });
        this.galleryWrap.forEach(function (eachWrap) {
          var imageLinks = eachWrap.querySelectorAll('a');
          imageLinks.forEach(function (each) {
            each.addEventListener('click', function (event) {
              return _this.openPicture(event, _this.plugin, imageLinks);
            });
          });
        });
      }
    ...
    key: "openPicture",
    value: function openPicture(event, plugin, images) {
...
var Blog = /*#__PURE__*/function () {
  ...
  _createClass(Blog, [{
    ...
    value: function init() {
      ...
      if (location.pathname.indexOf('blog/page') !== -1 || location.pathname.indexOf('blog/find') !== -1) {
        this.getData().then(function (responses) {
          ...
          _this.createCategoryWidget(data);

          _this.createLatestWidget(data);

          _this.createTagWidget(data);

          _this.createFindPage(data);

          _this.createPagination(data);
    ...
    value: function getData() {
      return Promise.all([fetch('data/data-blog.json'), fetch('data/data-category.json'), fetch('data/data-tag.json')]);
    }
  }, {
    key: "contentTruncate",
    value: function contentTruncate() {
      ...
      this.articleWrap.forEach(function (txt) {
        ...
        var truncateText = _this2.trimLongTitle(currentText.innerText, 150);
    ...
    value: function createCategoryWidget(data) {
      ...
      if (document.querySelector('.widget-categories') !== null) {
        ...
        categoryFilter.forEach(function (eachData) {
          _this3.categoryWrap.innerHTML += "<li><a href=\"find.html?category=".concat(eachData.category.toLowerCase(), "\" class=\"link-dark text-decoration-none\">").concat(eachData.category, "<span class=\"badge float-end\">").concat(eachData.totalPost, "</span></a></li>");
        });
      }
    }
  }, {
    ...
    value: function createLatestWidget(data) {
      ...
      if (document.querySelector('.widget-latest') !== null) {
        data[0].latestPost.forEach(function (each) {
          _this4.latestWrap.innerHTML += "\n                <li class=\"list-group-item bg-transparent px-0\">\n                    <a href=\"".concat(each.link, "\" class=\"link-dark text-decoration-none\">").concat(_this4.trimLongTitle(each.title, 55), "</a><br>\n                    <small class=\"text-muted\"><i class=\"fas fa-clock fa-sm me-1\"></i>").concat(each.date, "</small>\n                </li>\n                ");
        });
      }
    }
  }, {
    ...
    value: function createTagWidget(data) {
      ...
      if (document.querySelector('.widget-tag') !== null) {
        ...
        tagFilter.forEach(function (eachTag) {
          if (eachTag.length !== 0) {
            _this5.tagWrap.innerHTML += "<a href=\"find.html?tag=".concat(eachTag, "\"><span class=\"badge\">#").concat(eachTag, "</span></a>");
          } else {
            _this5.tagWrap.innerHTML = '<small class="text-muted">No tags available yet</small>';
          }
        });
      }
    }
    ...
    value: function createPagination(data) {
      if (location.pathname.indexOf("blog/find") == -1) {
        ...
        var page = parseInt(this.currentPage.substring(5).slice(0, -5));
        var liTag = '';
        var active = '';
        var beforePage = page - 1;
        var afterPage = page + 1; // hide pagination when only one page
        ...
        if (page > 3) {
          liTag += "<li class=\"page-item\"><a class=\"page-link\" href=\"page-1.html\" aria-label=\"previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>";
        }
        ...
        for (var plength = beforePage; plength <= afterPage; plength++) {
          ...
          liTag += "<li class=\"page-item ".concat(active, "\"><a class=\"page-link\" href=\"page-").concat(plength, ".html\">").concat(plength, "</a></li>");
        } // show the next button if the page value is less than totalPage(20)


        if (page < totalPages - 1) {
          liTag += "<li class=\"page-item\"><a class=\"page-link\" href=\"page-".concat(totalPages, ".html\" aria-label=\"next\"><span aria-hidden=\"true\">&raquo;</span></a></li>");
    ...
    value: function createFindPage(data) {
      ...
      if (location.pathname.indexOf('blog/find') != -1) {
        ...
        var textEl = document.querySelector('.in-find-text');
        var headingEl = document.querySelector('.in-find-heading');

        if (params.has('category')) {
          var categoryName = this.capitalizeText(params.get('category'));
          textEl.textContent = 'Post with category :';
          headingEl.innerHTML = "<i class=\"fas fa-folder-open fa-xs me-1 position-relative\" style=\"top: 3px;\"></i>".concat(categoryName); // write posts category into the dom

          data[1].filter(function (post) {
            if (post.category.toLowerCase() === categoryName.toLowerCase()) {
              var postWrap = document.querySelector('.in-blog-1');
              var selectedPost = post.posts;
              setTimeout(function () {
                selectedPost.forEach(function (each) {
                  var articleDiv = document.createElement('div');
                  articleDiv.innerHTML = _this6.postFormat(each);
        ...
        if (params.has('tag')) {
          var tagName = this.capitalizeText(params.get('tag'));
          textEl.textContent = 'Post with tag :';
          headingEl.innerHTML = "<i class=\"fas fa-tag fa-xs me-1 position-relative\" style=\"top: 3px;\"></i>".concat(tagName); // write posts tag into the dom
          ...
          data[2].filter(function (post) {
            if (post.tag.toLowerCase() === tagName.toLowerCase()) {
              ...
              selectedPost.forEach(function (post) {
                var articleDiv = document.createElement('div');
                articleDiv.innerHTML = _this6.postFormat(post);
                postWrap.appendChild(articleDiv);
              });
            }
          });
    ...
    value: function searchForm(data) {
      if (document.forms['blog-search'] !== undefined) {
        ...
        inputSearch.addEventListener('submit', function (e) {
          e.preventDefault(); // bootstrap input validation
          ...
          if (!inputSearch.checkValidity()) {
            ...
            location.href = "find.html?".concat(params.toString());
          }
        });
    ...
    value: function searchProcess(data) {
      ...
      if (location.pathname.indexOf("blog/find") != -1 && params.has('result')) {
        data.forEach(function (post) {
          var title = post.title.toLowerCase();
          var body = post.content.toLowerCase();
          textEl.textContent = 'Search result for :';
          headingEl.innerHTML = "<i class=\"fas fa-search fa-xs me-1 position-relative\" style=\"top: 3px;\"></i>".concat(_this7.capitalizeText(params.get('result')));
          ...
          if (title.indexOf(params.get('result')) > -1 || body.indexOf(params.get('result')) > -1) {
            var articleDiv = document.createElement('div');
            articleDiv.innerHTML = _this7.postFormat(post);
            postWrap.appendChild(articleDiv);
          }
        });
    ...
    value: function postFormat(_ref2) {
      ...
      return "\n    <article class=\"card mb-4\">\n        <div class=\"card-body blog-card p-3 p-md-4\">\n            <h3 class=\"fw-bold\">\n                <a href=\"".concat(link, "\" class=\"link-dark text-decoration-none\">").concat(title, "</a>\n            </h3>\n            <p>").concat(content, "</p>\n            <div class=\"blog-author d-flex align-items-center\">\n                <img class=\"rounded-circle me-1\" src=\"../index.html").concat(author.avatar, "\" alt=\"author\" width=\"32\" height=\"32\">\n                <small class=\"text-muted\">\n                    ").concat(author.name, "<span class=\"mx-1\">\u2022</span>").concat(date, "\n                </small>\n            </div>\n        </div>\n        <div class=\"card-footer blog-footer d-flex justify-content-between align-items-center px-3 px-md-4 py-2\">\n            <span class=\"badge bg-secondary\">").concat(category, "</span>\n            <a href=\"").concat(link, "\" class=\"btn btn-link text-decoration-none p-0\">Read more<i class=\"fas fa-angle-right fa-xs ms-1\"></i></a>\n        </div>\n    </article>\n    ");
    }
  }, {
    key: "checkDiff",
    ...
    value: function trimLatestWidget() {
      ...
      if (document.querySelector('.widget-latest') !== null) {
        ...
        titleList.forEach(function (title) {
          return title.textContent = _this8.trimLongTitle(title.textContent, 55);
        });
      }
    }
  }, {
  ...
  _createClass(Breadcrumb, [{
    ...
    value: function init() {
      if (document.querySelector(".".concat(this.breadcrumbElement)) !== null) {
        ...
        this.createBreadcrumbBlog(this.breadcrumbHome, this.blogTitle);
      }
    }
  }, {
    ...
    value: function createBreadcrumb(element) {
      var createLiElement;
      this.breadcrumb.innerHTML = "<li class=\"breadcrumb-item\"><a href=\"".concat(this.breadcrumbHome.slice(location.pathname.lastIndexOf('https://www.indonez.com/') + 1), "\">").concat(this.homeTitle, "</a></li>");
      this.breadcrumbTitle.forEach(function (e) {
        ...
        createLiElement.innerHTML = "<a href=\"".concat(e.getAttribute('href'), "\">").concat(e.textContent, "</a>");
    ...
    value: function createBreadcrumbBlog(pathParam, title) {
      if (this.pageTitle.includes(title)) {
        ...
        this.breadcrumb.innerHTML = "<li class=\"breadcrumb-item\"><a href=\"".concat(pathParam, "\">").concat(this.homeTitle, "</a></li>");
        breadcrumbCurrent.forEach(function (e) {
          if (e.textContent.toLowerCase() == title) {
            ...
            levelOne.innerHTML = e.textContent; // if blog inside child on nav

            if (e.closest('.dropdown-menu') !== null) {
              levelOne.innerHTML = e.textContent;
              levelTwo.innerHTML = "<a href=\"".concat(e.closest('.dropdown-menu').previousElementSibling.getAttribute('href'), "\">").concat(e.closest('.dropdown-menu').previousElementSibling.textContent, "</a>");
...
var CarouselConfig = /*#__PURE__*/function () {
  ...
  _createClass(CarouselConfig, [{
    ...
    value: function init() {
      ...
      if (document.querySelector(".".concat(this.carouselClass)) !== null) {
        var carouselWrap = document.querySelector(".".concat(this.carouselClass));
        var carouselId = carouselWrap.getAttribute('id');
        new bootstrap.Carousel(carouselWrap, {
          interval: this.settings.interval
        }); // give class active for first carousel item

        this.carouselItems[0].classList.add('active'); // fade transition option
        ...
        if (document.querySelector('.carousel-indicators') !== null) {
          ...
          this.carouselItems.forEach(function (each, index) {
            ...
            btnIndicator.setAttribute('data-bs-target', "#".concat(carouselId));
        ...
        if (window.matchMedia('(min-width: 992px)').matches) {
          this.carouselItems.forEach(function (each) {
            each.style.minHeight = _this.settings.height.desktop;
          });
        } else if (window.matchMedia('(min-width: 768px)').matches) {
          this.carouselItems.forEach(function (each) {
            each.style.minHeight = _this.settings.height.tablet;
          });
        } else {
          this.carouselItems.forEach(function (each) {
            each.style.minHeight = _this.settings.height.phone;
          });
        }
      }
    }
  ...
  _createClass(ContactForm, [{
    ...
    value: function init() {
      ...
      document.addEventListener('DOMContentLoaded', function () {
        if (typeof _this.buttonSend !== 'undefined' && _this.buttonSend !== null) {
          _this.buttonSend.addEventListener('click', function (event) {
            event.preventDefault();

            var postdata = _this.serialize(_this.contactForm); // bootstrap input validation


            if (!_this.contactForm.checkValidity()) {
              event.preventDefault();
              event.stopPropagation();

              _this.setLoading(_this.buttonSend);

              _this.contactForm.classList.add('was-validated');
            } else {
              _this.setLoading(_this.buttonSend, 'success');
            }

            _this.ajaxRequest('POST', 'sendmail.html', postdata, function (success, response) {
              if (success) {
                ...
                if (result.isSuccess) {
                  ...
                  setTimeout(function () {
                    ...
                    _this.contactForm.classList.remove('was-validated');
    ...
    key: "setLoading",
    value: function setLoading(btnElem, status) {
      if (status == 'success') {
...
/* counter-up.js | https://github.com/DarioCorno/counterUp | DarioCorno | MIT License */
var CounterUp = /*#__PURE__*/function () {
  function CounterUp(_props) {
    ...
    this.domelems.forEach(function (el) {
      ...
      intval == null ? cur.intvalues = self.props.intvalues : cur.intvalues = intval; //step to increments at every tic
  ...
  _createClass(CounterUp, [{
    ...
    value: function update() {
      ...
      this.elems.forEach(function (el) {
        ...
        if (el.val < el.end) {
          if (el.intvalues == true) el.obj.innerHTML = el.prepend + Math.floor(el.val).toLocaleString().toString() + el.append;else el.obj.innerHTML = el.prepend + (Math.round(el.val * 100) / 100).toLocaleString().toString() + el.append;
          alldone = false;
        } else {
...
var MobileNavbar = /*#__PURE__*/function () {
  function MobileNavbar(settings) {
    ...
    this.buttons = settings.buttons; // required variables
  ...
  _createClass(MobileNavbar, [{
    ...
    key: "createMobileNav",
    value: function createMobileNav(navbar) {
      // cloned navbar manipulation
      Array.from(navbar.children).forEach(function (each) {
        ...
        if (each.classList.contains('dropdown')) {
          ...
          each.children[0].setAttribute('data-bs-target', "#".concat(each.children[0].textContent.toLowerCase().replace(/\s/g, '-')));
          ...
          Array.from(each.children[1].children).forEach(function (li) {
            // dropdown child text manipulation
            if (!li.children[0].classList.contains('dropdown-item')) {
              var parentChildren = li.parentElement;
              var childrenCloned = li.children[0].querySelector('.list-unstyled').cloneNode(true);
              Array.from(childrenCloned.children).forEach(function (li) {
      ...
      btnOpen.innerHTML = '<i class="fas fa-bars"></i>'; // modal wrapper
    ...
    key: "createButtonListener",
    value: function createButtonListener() {
      var btnModal = document.querySelectorAll('.btn-mobile-navbar');
      btnModal.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          var parent = document.querySelector('.loaded');
          var sticky = document.querySelector('.sticky-nav');
          var toggle = parent.classList.toggle('show');
    ...
    key: "createAddonBtn",
    value: function createAddonBtn() {
      var optionalNav = this.optionalNav;
      var methodUrl = this.addonBtnUrl;
      var methodName = this.addonBtnName;
      var methodIcon = this.addonBtnIcon;
      var signinBtn = '';

      if (this.addonButtons && this.optionalNav !== null && this.optionalNav.children.length > 0) {
        this.buttons.forEach(function (e) {
          signinBtn += "<a href=\"".concat(methodUrl(e, optionalNav), "\" class=\"btn btn-").concat(e.type, " w-100 mt-1\">").concat(methodName(e, optionalNav)).concat(methodIcon(e), "</a>");
        });
      }
    ...
    key: "addonBtnUrl",
    value: function addonBtnUrl(data, element) {
      var urlValue;
      data.url.length > 0 ? urlValue = data.url : urlValue = element.querySelector('a').href;
      return urlValue;
    }
  }, {
    key: "addonBtnName",
    value: function addonBtnName(data, element) {
      var nameValue;
      data.name.length > 0 ? nameValue = data.name : nameValue = element.querySelector('a').innerText;
      return nameValue;
    }
  }, {
    key: "addonBtnIcon",
    value: function addonBtnIcon(data) {
      var iconValue;
      data.icon !== undefined && data.icon.length > 0 ? iconValue = "<i class=\"fas fa-".concat(data.icon, " ms-1\"></i>") : iconValue = '';
      return iconValue;
    }
  }]);
...
new MobileNavbar({
  addonButtons: true,
  // options to use addon buttons, set it "false" if you won't use addon buttons
  buttons: [{
    name: 'Sign in',
    // button name
    url: '',
    // button url
    type: 'primary',
    // button type (default, primary, secondary, danger, text)
    ...
    value: function init() {
      ...
      if (this.animation) {
        window.addEventListener('load', function () {
          return document.querySelector('body').classList.add(_this.class);
        });
      }
    }
  }]);
...
var Plyr = /*#__PURE__*/function () {
  ...
  _createClass(Plyr, [{
    key: "init",
    value: function init() {
      if (document.querySelector(".".concat(this.elementName)) !== null) Plyr.setup('.media');
    }
  }]);
...
var StickyMenu = /*#__PURE__*/function () {
  ...
  _createClass(StickyMenu, [{
    ...
    value: function init() {
      ...
      if (document.querySelector(".".concat(this.navbarName)) !== null) {
        // required variables
        this.navbarEl = document.querySelector(".".concat(this.navbarName));
        ...
        this.stickyNav.appendChild(this.clonedNav); // manipulate cloned navbar
        ...
        this.stickyNav.children[0].children[3].remove(); // hide optional nav element condition
        ...
        window.addEventListener('scroll', function () {
          if (_this.showOnUp) {
            ...
            if (oldValue > newValue) _this.stickyNav.classList.add('active');
            if (oldValue < newValue) _this.stickyNav.classList.remove('active');
            if (window.scrollY < 350) _this.stickyNav.classList.remove('active');
            oldValue = newValue;
          } else {
            window.scrollY > 350 ? _this.stickyNav.classList.add('active') : _this.stickyNav.classList.remove('active');
          }
        });
      }
    }
