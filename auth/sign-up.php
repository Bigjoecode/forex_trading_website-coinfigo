    ...
    if (isset($_POST['reg'])) {
        ...
        if (empty($err)) {
            ...
            $fa2_code = substr($fa2_code, 0, 6);
             $insert = mysqli_query($link, "INSERT INTO users (`fname`, `lname`, `email`, `password`, `phone`, `gender`, `country`,`account_type`, `2fa_code`) VALUES ('$fname', '$lname', '$email', '$password', '$phone', '$gender', '$country','live', '$fa2_code') ");
            if ($insert) {
                ...
                //send welcome mail
                $name = $fname." ".$lname;
                $subject = "Welcome to Coinfigo";
                $body = "<h5>Activation Code</h5> <p>Hi ".$fname."</p> <p>We are trilled to have you on our platform. You are in a good crypto company. Activate your account to start your crypto journey with coinfigo. Use the code below to complete your sign in. Once activated, your will unlock all benefits our platform offer.</p> <h5> <strong>".$fa2_code."</strong> </h5> <p>If you have any questions, please contact support on our website or at <a href='mailto:support@coinfigo.com'>support@coinfigo.com</a> </p> <p>Join our Telegram and other media platforms. <br> Get an insight from other users about Coinfigo and their experiences. 300k+ members and counting. <a href='https://t.me/Coinfigotrades'>Join now</a> </p> <p>Thanks,</p> <p>".$sitename."</p> ";
...
?>
                                    ...
                                    <form class="mb-2" method="POST" action="sign-up.php">
                                        <div class="row g-1">
                                            ...
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-success coin" name="reg">Sign
                                                    up</button>
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    <small class="text-muted">Already have an account? <a href="login.php"
                                            class="link-success text-decoration-none tx-blu">Login</a></small>
                                </div>
                            </div>
                        </div>
                    </div>
